...
async function runMixingChorusDemo() {
  ...
  // ----------------------------------------------------------------
  // PART 4 — Scrub around the timeline
  // ----------------------------------------------------------------
  ...
  // ----------------------------------------------------------------
  // PART 5 — Scenes: assign guitar tracks to Scene A, leave Vox out
  // ----------------------------------------------------------------
...
document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("run-demo-mixing-chorus").addEventListener("click", () =>
    showDemoIntro(
      "Starting from recorded tracks, we'll refine the chorus — adjusting gain, soloing parts to check the blend, scrubbing the timeline, and using scenes to manage the guitar and vocal layers.",
      runMixingChorusDemo
    )
  );
});
